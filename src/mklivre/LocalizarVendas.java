 ...
 * @author willi
 */
public class LocalizarVendas extends javax.swing.JFrame {
    Connection conexao = null;
    PreparedStatement pst = null;
    ResultSet rs = null;
    /**
     * Creates new form LocalizarVendas
     */
    public LocalizarVendas() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel20.setText("CÓDIGO DA VENDA");
        getContentPane().add(jLabel20);
        jLabel20.setBounds(10, 100, 210, 17);
        ...
        botaoEntrarIniciall4.setText("TODAS AS VENDAS");
        ...
        botaoEntrarIniciall4.setBounds(210, 190, 210, 40);

        jLabel14.setFont(new java.awt.Font("Tahoma", 1, 21)); // NOI18N
        jLabel14.setForeground(new java.awt.Color(255, 255, 255));
        jLabel14.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel14.setText("LOCALIZAR VENDAS");
        getContentPane().add(jLabel14);
        jLabel14.setBounds(170, 10, 230, 60);
        ...
        setSize(new java.awt.Dimension(447, 278));
    ...
    private void botaoEntrarIniciall4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botaoEntrarIniciall4ActionPerformed
        ItensVendidos tudo = new ItensVendidos();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LocalizarVendas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LocalizarVendas().setVisible(true);
            }
        });
    }

 ...
 * @author willi
 */
public class RegistroExecucoes extends javax.swing.JFrame {
    Connection conexao = null;
    PreparedStatement pst = null;
    ResultSet rs = null;
    /**
     * Creates new form RegistroExecucoes
     */
    public RegistroExecucoes() {
        initComponents();
    ...
    private void adicionar(){
        String sql = "insert into exec_of2(os_aux,SERVIÇO,HORA_INICIAL,HORA_FINAL,DURAÇÃO,OBSERVAÇÕES,TIPO_DE_ORDEM,MECÂNICO,DIA,HINICIAL,MINICIAL,HORAFINAL,MINIFINAL,DIAS,MÊS,ANO,HISTÓRICO,COMP,APARELHO) values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
        try {
            pst = conexao.prepareStatement(sql);
		...
		duracao-=60;
            ...
            pst.setString(2,servicoDaOs.getSelectedItem().toString());
            pst.setString(3,passahoraI);
            pst.setString(4,passahoraF);
            pst.setString(5,tempo);
            pst.setString(6,cadastroObservacoes.getText());
            pst.setString(7,tipoDaOS.getSelectedItem().toString());
            pst.setString(8,campoMecanicos.getSelectedItem().toString());
            pst.setString(9,data);
            pst.setString(10,horaInicial.getValue().toString());
            pst.setString(11,minutoInicial.getValue().toString());
            pst.setString(12,horaFinal.getValue().toString());
            pst.setString(13,minutoFinal.getValue().toString());
            pst.setInt(14,Integer.parseInt(dataDia.getValue().toString()));
            pst.setInt(15,Integer.parseInt(dataMes.getValue().toString()));
            pst.setInt(16,Integer.parseInt(dataAno.getValue().toString()));
            pst.setString(17,servicoDaOs.getSelectedItem().toString()+" "+data);
            pst.setInt(18,comp);
            pst.setString(19,aparelho.getText());
            pst.executeUpdate();
            JOptionPane.showMessageDialog(null,"EXECUÇÃO CADASTRADA COM SUCESSO");
            ...
            execucoes.historico.setText(servicoDaOs.getSelectedItem().toString()+" "+data);
            atualizaData();
            this.dispose();
        } catch (Exception e) {
            JOptionPane.showMessageDialog(null, e);
    ...
    private void atualizaData(){
        String sql = "update mantemData set dia=?,mes=?,ano=? where id=?";
        try {
            pst = conexao.prepareStatement(sql);
            pst.setString(1,dataDia.getValue().toString());
            pst.setString(2,dataMes.getValue().toString());
            pst.setString(3,dataAno.getValue().toString());
            pst.setInt(4,1);
            pst.executeUpdate();
        } catch (Exception e) {
            JOptionPane.showMessageDialog(null, e);
    ...
    private void pegaData(){
        String sql ="select * from mantemdata where id=?";
        try {
            pst = conexao.prepareStatement(sql);
            pst.setInt(1,1);
            rs=pst.executeQuery();
            while(rs.next()){
                dataDia.setValue(Integer.parseInt(rs.getString("dia")));
                dataMes.setValue(Integer.parseInt(rs.getString("mes")));
                dataAno.setValue(Integer.parseInt(rs.getString("ano")));
            }
        } catch (Exception e) {
            JOptionPane.showMessageDialog(null,e);
        }
    ...
    private void initComponents() {
        ...
        setTitle("ADICIONAR REGISTRO DE EXECUÇÕES");
        setResizable(false);
        ...
        jLabel14.setText("CADASTRO EXECUÇÕES");
        ...
        dataVenda.setText("jLabel2");
        getContentPane().add(dataVenda);
        dataVenda.setBounds(650, 120, 34, 15);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RegistroExecucoes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RegistroExecucoes().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTextField cadastroOS;
    private javax.swing.JTextArea cadastroObservacoes;
    private javax.swing.JComboBox<String> campoMecanicos;
    private javax.swing.JSpinner dataAno;
    private javax.swing.JSpinner dataDia;
    private javax.swing.JSpinner dataMes;
    private javax.swing.JLabel dataVenda;
    private javax.swing.JSpinner horaFinal;
    private javax.swing.JSpinner horaInicial;
    ...
    private javax.swing.JSpinner minutoInicial;
    public static javax.swing.JLabel mostrarNivel;
    private javax.swing.JComboBox<String> servicoDaOs;
    private javax.swing.JComboBox<String> tipoDaOS;

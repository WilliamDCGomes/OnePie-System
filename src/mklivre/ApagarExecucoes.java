 ...
 * @author willi
 */
public class ApagarExecucoes extends javax.swing.JFrame {
    Connection conexao = null;
    PreparedStatement pst = null;
    ResultSet rs = null;
    /**
     * Creates new form ApagarExecucoes
     */
    public ApagarExecucoes() {
        initComponents();
    ...
    private void initComponents() {
        ...
        codPeca.setBounds(60, 130, 280, 40);

        jLabel20.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel20.setForeground(new java.awt.Color(255, 255, 255));
        jLabel20.setText("ORDEM DE SERIÇO");
        getContentPane().add(jLabel20);
        jLabel20.setBounds(60, 100, 170, 17);
        ...
        botApagarItem.setBounds(390, 130, 140, 40);

        jLabel14.setFont(new java.awt.Font("Tahoma", 1, 21)); // NOI18N
        jLabel14.setForeground(new java.awt.Color(255, 255, 255));
        jLabel14.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel14.setText("INSIRA AS INFORMAÇÕES DA EXECUÇÃO");
        getContentPane().add(jLabel14);
        jLabel14.setBounds(130, 10, 500, 60);
        ...
        setSize(new java.awt.Dimension(643, 231));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ApagarExecucoes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ApagarExecucoes().setVisible(true);
            }
        });
    }

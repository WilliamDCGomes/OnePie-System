 ...
 * @author willi
 */
public class LocalizarEdicaoVenda extends javax.swing.JFrame {
    Connection conexao = null;
    PreparedStatement pst = null;
    ResultSet rs = null;
    /**
     * Creates new form LocalizarEdicaoVenda
     */
    public LocalizarEdicaoVenda() {
        initComponents();
    ...
    private void consultar2(){
        ...
        try {
            ...
            rs = pst.executeQuery();
            if (rs.next()) {
                EditarVenda usuario = new EditarVenda();
                usuario.setVisible(true);
                usuario.codigoCliente.setText(rs.getString("CÓDIGO_DO_CLIENTE"));
                this.dispose();
            }
            else{
                JOptionPane.showMessageDialog(null,"VENDA NÃO ENCONTRADA NO BANCO DE DADOS!");
            }
        } catch (Exception e) {
    ...
    private void initComponents() {
        ...
        botaoEntrarIniciall3.setBounds(30, 180, 140, 40);

        jLabel14.setFont(new java.awt.Font("Tahoma", 1, 21)); // NOI18N
        jLabel14.setForeground(new java.awt.Color(255, 255, 255));
        jLabel14.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel14.setText("LOCALIZAR VENDA");
        ...
        jLabel19.setBounds(30, 100, 210, 17);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LocalizarEdicaoVenda.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LocalizarEdicaoVenda().setVisible(true);
            }
        });
    }

 ...
 * @author willi
 */
public class ApagarItensEs extends javax.swing.JFrame {
    Connection conexao = null;
    PreparedStatement pst = null;
    ResultSet rs = null;
    /**
     * Creates new form ApagarItensEs
     */
    public ApagarItensEs() {
        initComponents();
    ...
    private void initComponents() {
        ...
        codPeca.setBounds(60, 130, 210, 30);
        ...
        setSize(new java.awt.Dimension(545, 313));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ApagarItensEs.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ApagarItensEs().setVisible(true);
            }
        });
    }

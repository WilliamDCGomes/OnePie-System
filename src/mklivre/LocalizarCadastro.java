 ...
 * @author willi
 */
public class LocalizarCadastro extends javax.swing.JFrame {
    Connection conexao = null;
    PreparedStatement pst = null;
    ResultSet rs = null;
    /**
     * Creates new form LocalizarCadastro
     */
    public LocalizarCadastro() {
        initComponents();
    ...
    private void initComponents() {
        ...
        botaoEntrarIniciall4.setText("TODOS OS USUÁRIOS");
        ...
        botaoEntrarIniciall4.setBounds(30, 250, 240, 40);
    ...
    private void botaoEntrarIniciall3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botaoEntrarIniciall3ActionPerformed
        if(nomePeca.getText().equals("")){
            JOptionPane.showMessageDialog(null,"DIGITE UM CÓDIGO OU ALGUM NOME");
        }
        else{
            consultar2();
        }
    ...
    private void botaoEntrarIniciall4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botaoEntrarIniciall4ActionPerformed
        TodosOsUsuarios users = new TodosOsUsuarios();
        users.setVisible(true);
        users.mostrarNivel.setText(mostrarNivel.getText());
        users.acessoUser.setText(acessoUser.getText());
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LocalizarCadastro.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LocalizarCadastro().setVisible(true);
            }
        });
    }

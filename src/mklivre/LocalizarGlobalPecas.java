 ...
 * @author willi
 */
public class LocalizarGlobalPecas extends javax.swing.JFrame {
    Connection conexao = null;
    PreparedStatement pst = null;
    ResultSet rs = null;
    /**
     * Creates new form LocalizarGlobalPecas
     */
    public LocalizarGlobalPecas() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel20.setBounds(10, 100, 70, 17);
        ...
        botaoEntrarIniciall4.setText("TODOS OS ITENS");
        ...
        botaoEntrarIniciall4.setBounds(210, 190, 190, 40);

        jLabel14.setFont(new java.awt.Font("Tahoma", 1, 21)); // NOI18N
        jLabel14.setForeground(new java.awt.Color(255, 255, 255));
        jLabel14.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel14.setText("LOCALIZAR ITENS");
        getContentPane().add(jLabel14);
        jLabel14.setBounds(170, 10, 210, 60);
        ...
        setSize(new java.awt.Dimension(422, 276));
    ...
    private void consultarML(){
        ...
        try {
            ...
            if (rs.next()) {
                ...
                usuario.nomePeca.setText(rs.getString(1));
                usuario.codigoCadastrado.setText(rs.getString(2));
                usuario.custoCadastrado.setText(rs.getString(3).replace(".",","));
                usuario.precoDeVenda.setText(rs.getString(4).replace(".",","));
                usuario.marcaCadastrada.setText(rs.getString(5));
                usuario.quantCadastrada.setText(rs.getString(7));
                usuario.localizacaoCadastrada.setText(rs.getString(11));
                usuario.lucroCadastrado.setText(rs.getString(16).replace(".",","));
                ...
                JOptionPane.showMessageDialog(null,"PEÇA NÃO LOCALIZADA NO BANCO DE DADOS!");
                tent=0;
            }
        } catch (Exception e) {
    ...
    private void consultarES(){
        ...
        try {
            ...
            if (rs.next()) {
                ...
                usuario.nomePeca.setText(rs.getString(1));
                usuario.codigoCadastrado.setText(rs.getString(2));
                usuario.caixaLocalizada.setText(rs.getString(3));
                usuario.custoCadastrado.setText(rs.getString(7).replace(".",","));
                usuario.precoDeVenda.setText(rs.getString(8).replace(".",","));
                usuario.marcaCadastrada.setText(rs.getString(5));
                usuario.quantCadastrada.setText(rs.getString(6));
                usuario.localizacaoCadastrada.setText(rs.getString(4));
                usuario.lucroCadastrado.setText(rs.getString(13).replace(".",","));
    ...
    private void botaoEntrarIniciall3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botaoEntrarIniciall3ActionPerformed
        ...
        else if(acessoUser.getText().equals("ML")){
            consultarML();
        }
        else if(acessoUser.getText().equals("ES")){
            consultarES();
        }
        else{
            consultarML();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LocalizarGlobalPecas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LocalizarGlobalPecas().setVisible(true);
            }
        });
    }

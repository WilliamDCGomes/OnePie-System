...
public class EditarMecanico extends javax.swing.JFrame {
    ...
    private void alterar(){
        String sql = "update mecanicos set situacao=? where nome_mecanico=?";
        try {
            pst=conexao.prepareStatement(sql);
            pst.setString(2,cadastroNome.getText());
            ...
            pst.executeUpdate();
            JOptionPane.showMessageDialog(null,"MECÂNICO ATUALIZADO COM SUCESSO");
    ...
    private void initComponents() {
        ...
        jLabel14.setBounds(110, 10, 320, 60);
        ...
        setSize(new java.awt.Dimension(440, 356));
